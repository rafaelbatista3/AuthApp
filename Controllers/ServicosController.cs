...
namespace AuthApp.Controllers
{
    public class ServicosController : Controller
    {
        ...
        {
            var findServico = from b in _context.Servicos
                              select b;
            if (!String.IsNullOrEmpty(searchString))
            {
                findServico = findServico.Where(b => b.Tipo.Contains(searchString));
            }
            ViewBag.Title = "Serviços";
            return View(findServico);
        ...
        public async Task<IActionResult> Create([Bind("Id,Tipo,Valor,Descricao")] Servicos servicos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Tipo,Valor,Descricao")] Servicos servicos)
        {
            if (id != servicos.Id)
            {
                return NotFound();
